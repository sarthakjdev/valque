...
const queuePlayingembed = new MessageEmbed().setAuthor('QUE Bot', `${thumbnail}`).setDescription('Click on the button below to search for a queue. And wait for enough players to join in the queue to start the matchmaking.').setThumbnail(`${thumbnail}`)
